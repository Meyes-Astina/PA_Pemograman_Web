...
if (isset($_GET['delete'])) {
    ...
    header('location:../views/admin_product.php');
}
        ...
        <div class="box-container">
            ...
            ?>
                    <div class="box">
                        ...
                        <p>price : Rp.<?php echo $fetch_product['price']; ?></p>
                        <h4><?php echo $fetch_product['name']; ?></h4>
                        <details><?php echo $fetch_product['product_detail']; ?></details>
                        <a href="../views/admin_product.php?edit=<?php echo $fetch_product['id']; ?>" class="edit">edit</a>
                        <a href="../views/admin_product.php?delete=<?php echo $fetch_product['id']; ?>" class="delete" onclick="return confirm('want to delete this product');">delete</a>
                    </div>
            <?php
                }
            } else {
